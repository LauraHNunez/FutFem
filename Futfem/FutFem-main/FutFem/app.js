$(document).ready(function(){
  ...
  var trivia = {
    ...
    questions: {
      ...
      q13: "Que jugadora del Barça marcó el gol de la victoria en la final de la champions de Eindhoven en 2023?",
      q14: "Jugadora estadounidense que de cara al mundial de Australia y Nueva Zelanda han hecho una estatua similar a la Estatua de la Libertad?",
      q15: "Jugadora que en el verano de 2023 ha vuelta a fichar por el barça despues de irse a jugar a la liga Inglesa?",
      q16: "Quien es la capitana de England Lionesses para la copa Mundial de 2023?",
      q17: "Donde se juega la final de la champions femenina en 2024 y 2025? Orden Correcto",
      q18: "Cual es la posicion de Leila Ouhababi en el campo?",
      q19: "En el encuentro España vs Panama de 2023 antes del Mundial que dorsal llevó Jana Fernandez?",
      q20: "Quien ganó la copa de la Reina 2023?"
    },
    options: {
      ...
      q13: ['Patri Guijarro', 'Fridolina Rölfo', 'Alexia Putellas','Geyse Ferreira'],
      q14: ['Megan Rapinoe', 'Alex Morgan', "Kelley O'Hara",'Lindsey Horan'],
      q15: ['Vicky Losada', 'Jennifer Hermoso', 'Laia Aleixandri','Ona Batlle'],
      q16: ['Leah Williamson', 'Rachel Daly', 'Alex Greenwood','Millie Bright'],
      q17: ['Santander - Lisboa', 'Bilbao-Madeira', 'Bilbao-Lisboa','Turín-Paris'],
      q18: ['Extrema izquierda', 'Lateral derecha', 'Interior izquierda','Lateral izquierda'],
      q19: ['11', '6', '14','5'],
      q20: ['Real Sociedad', 'Atlético de Madrid', 'Real Madrid','FC Barcelona']
    },
    answers: {
      q1: 'Alexia Putellas',
      q2: 'Jill Roord',
      ...
      q16: 'Millie Bright',
      q17: 'Bilbao-Lisboa',
      q18: 'Lateral izquierda',
      q19: '14',
      q20: 'Atlético de Madrid'
    },
    ...
    connect : function(){
      async function main(){
        ...
        const uri = "mongodb+srv://Hang Nuñez Barragan:Amor812217*@localhost:27017/FutFemGame";
  
        const client = new MongoClient(uri);
        
        MongoClient.connect(uri,function(err,client){
          const db = client.db('FutFemGame');
          db.collection('Trivia').find().toArray(function(err,docs){
            console.log(docs);
          });
